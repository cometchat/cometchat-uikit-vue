import CometChatConversationListItem from '../CometChatWorkspace/src/components/Chats/CometChatConversationListItem/CometChatConversationListItem';
...
export default {
  title: 'UI Kit/Chats/CometChatConversationListItem',
  component: CometChatConversationListItem,
};

const Template = (args) => ({
  components: {CometChatConversationListItem },
  setup() {
    return { args };
  },
  template: '<comet-chat-conversation-list-item v-bind="args" />',
});
