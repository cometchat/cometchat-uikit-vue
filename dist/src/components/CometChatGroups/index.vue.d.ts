...
import { TitleAlignment, States, SelectionMode, CometChatOption } from "@cometchat/uikit-resources";
...
declare const _sfc_main: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    subtitleView: {
        type: PropType<(group: CometChat.Group) => ViewType>;
    };
    menus: {
    ...
    options: {
        type: PropType<(group: CometChat.Group) => CometChatOption[]>;
    };
    groupsRequestBuilder: {
        type: PropType<import("@cometchat/chat-sdk-javascript").GroupsRequestBuilder>;
    };
    ...
    onSelect: {
        type: PropType<(group: CometChat.Group, selected: boolean) => void>;
    };
    searchIconURL: {
        type: StringConstructor;
        default: string;
    ...
    onItemClick: {
        type: PropType<(group: CometChat.Group) => void>;
    };
    onError: {
    ...
    fetchNextGroupsList: () => Promise<void>;
    Groups: Ref<import("@cometchat/chat-sdk-javascript").Group[], import("@cometchat/chat-sdk-javascript").Group[]>;
    myavatarStyle: Ref<{
        borderRadius?: string;
        width?: string;
        height?: string;
    ...
    getGroupIcon: (group: CometChat.Group) => any;
    ...
    handleSelection: (event: CustomEvent, group: CometChat.Group) => void;
