...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    currentTargetUser: Ref<any>;
    currentTargetGroup: Ref<any>;
    MessageBubbleAlignment: typeof MessageBubbleAlignment;
    theme: Ref<CometChatTheme>;
    closeThreadView: () => void;
    threadMessageObject: Ref<any>;
    child_component: any;
    openThreadedMessages: Ref<boolean>;
    ...
    reactionName: Ref<string>;
    openDetails: Ref<boolean>;
    getHeaderMenu: () => any[];
    liveReaction: Ref<boolean>;
    avatarStyle: AvatarStyle;
    closeDetailsPage: () => void;
    showPanelView: Ref<boolean>;
    getPanelComponentView: () => ViewType;
    panelBackgroundRef: any;
    panelDivStyle: Ref<{
