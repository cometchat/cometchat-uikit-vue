...
import { CardBubbleStyle, CometChatMentionsTextFormatter, CometChatTextFormatter, CometChatUrlTextFormatter, FormBubbleStyle, SchedulerBubbleStyle } from "@cometchat/uikit-shared";
...
export declare abstract class DataSourceDecorator implements DataSource {
    ...
    getTextMessageContentView(message: CometChat.TextMessage, alignment: MessageBubbleAlignment, theme: CometChatTheme, otherParams?: any): any;
    ...
    getAttachmentOptions(theme: CometChatTheme, id?: Map<string, any> | undefined): any;
    ...
    getSchedulerMessageBubble(message: SchedulerMessage, theme: CometChatTheme, style?: SchedulerBubbleStyle): any;
