...
import { GroupMembersStyle, ConversationUtils, GroupMemberUtils } from "@cometchat/uikit-shared";
...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    GroupMembers: Ref<import("@cometchat/chat-sdk-javascript").GroupMember[]>;
    wrapperStyle: any;
    membersStyle: () => {
        padding: any;
    };
