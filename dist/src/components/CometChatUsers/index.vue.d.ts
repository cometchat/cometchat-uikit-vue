...
declare const _sfc_main: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    onItemClick: {
        type: PropType<(user: CometChat.User) => void>;
    };
    onError: {
    ...
    Users: Ref<import("@cometchat/chat-sdk-javascript").User[], import("@cometchat/chat-sdk-javascript").User[]>;
    States: typeof States;
    onSearch: (text: string) => void;
    searchKeyword: Ref<string, string>;
    getActiveUser: (user: CometChat.User) => boolean;
    onClick: (user: CometChat.User) => void;
    getStatusIndicatorColor: (user: CometChat.User) => string;
    setThemeStyle: () => void;
    userStyle: () => any;
    myavatarStyle: Ref<{
        borderRadius?: string;
